...
pub mod csr {
  ...
  pub const GRABBER0_BASE: *mut u32 = 0xe0008000 as *mut u32;
  ...
  pub mod grabber0 {
    ...
    pub const PLL_RESET_ADDR: *mut u32 = 0xe0008000 as *mut u32;
    ...
    pub const PLL_LOCKED_ADDR: *mut u32 = 0xe0008008 as *mut u32;
    ...
    pub const PHASE_SHIFT_ADDR: *mut u32 = 0xe0008010 as *mut u32;
    pub const PHASE_SHIFT_SIZE: usize = 1;

    #[inline(always)]
    pub unsafe fn phase_shift_read() -> u8 {
      read_volatile(PHASE_SHIFT_ADDR) as u8
    }

    #[inline(always)]
    pub unsafe fn phase_shift_write(w: u8) {
      write_volatile(PHASE_SHIFT_ADDR.offset(0), (w) as u32);
    }

    pub const PHASE_SHIFT_DONE_ADDR: *mut u32 = 0xe0008018 as *mut u32;
    pub const PHASE_SHIFT_DONE_SIZE: usize = 1;

    #[inline(always)]
    pub unsafe fn phase_shift_done_read() -> u8 {
      read_volatile(PHASE_SHIFT_DONE_ADDR) as u8
    }

    pub const CLK_SAMPLED_ADDR: *mut u32 = 0xe0008020 as *mut u32;
    pub const CLK_SAMPLED_SIZE: usize = 1;

    #[inline(always)]
    pub unsafe fn clk_sampled_read() -> u8 {
      read_volatile(CLK_SAMPLED_ADDR) as u8
    }

    pub const FREQ_COUNT_ADDR: *mut u32 = 0xe0008028 as *mut u32;
    pub const FREQ_COUNT_SIZE: usize = 1;

    #[inline(always)]
    pub unsafe fn freq_count_read() -> u8 {
      read_volatile(FREQ_COUNT_ADDR) as u8
    }

    pub const LAST_X_ADDR: *mut u32 = 0xe0008030 as *mut u32;
    pub const LAST_X_SIZE: usize = 2;

    #[inline(always)]
    pub unsafe fn last_x_read() -> u16 {
      let r = read_volatile(LAST_X_ADDR) as u16;
      #[cfg(target_arch = "arm")]      dmb();
      let r = r << 8 | read_volatile(LAST_X_ADDR.offset(2)) as u16;
      #[cfg(target_arch = "arm")]      dmb();
      r
    }

    pub const LAST_Y_ADDR: *mut u32 = 0xe0008040 as *mut u32;
    pub const LAST_Y_SIZE: usize = 2;

    #[inline(always)]
    pub unsafe fn last_y_read() -> u16 {
      let r = read_volatile(LAST_Y_ADDR) as u16;
      #[cfg(target_arch = "arm")]      dmb();
      let r = r << 8 | read_volatile(LAST_Y_ADDR.offset(2)) as u16;
      #[cfg(target_arch = "arm")]      dmb();
      r
    }
  ...
  pub const RTIO_ANALYZER_BASE: *mut u32 = 0xe0009800 as *mut u32;
  ...
  pub mod rtio_analyzer {
    ...
    pub const ENABLE_ADDR: *mut u32 = 0xe0009800 as *mut u32;
    pub const ENABLE_SIZE: usize = 1;
    ...
    pub const BUSY_ADDR: *mut u32 = 0xe0009808 as *mut u32;
    ...
    pub const MESSAGE_ENCODER_OVERFLOW_ADDR: *mut u32 = 0xe0009810 as *mut u32;
    ...
    pub const MESSAGE_ENCODER_OVERFLOW_RESET_ADDR: *mut u32 = 0xe0009818 as *mut u32;
    ...
    pub const DMA_RESET_ADDR: *mut u32 = 0xe0009820 as *mut u32;
    ...
    pub const DMA_BASE_ADDRESS_ADDR: *mut u32 = 0xe0009828 as *mut u32;
    ...
    pub const DMA_LAST_ADDRESS_ADDR: *mut u32 = 0xe0009850 as *mut u32;
    ...
    pub const DMA_BYTE_COUNT_ADDR: *mut u32 = 0xe0009878 as *mut u32;
  ...
  pub const RTIO_CORE_BASE: *mut u32 = 0xe0008800 as *mut u32;
  ...
  pub mod rtio_core {
    ...
    pub const RESET_ADDR: *mut u32 = 0xe0008800 as *mut u32;
    pub const RESET_SIZE: usize = 1;
    ...
    pub const RESET_PHY_ADDR: *mut u32 = 0xe0008808 as *mut u32;
    ...
    pub const SED_SPREAD_ENABLE_ADDR: *mut u32 = 0xe0008810 as *mut u32;
    ...
    pub const ASYNC_ERROR_ADDR: *mut u32 = 0xe0008818 as *mut u32;
    ...
    pub const COLLISION_CHANNEL_ADDR: *mut u32 = 0xe0008820 as *mut u32;
    ...
    pub const BUSY_CHANNEL_ADDR: *mut u32 = 0xe0008830 as *mut u32;
    ...
    pub const SEQUENCE_ERROR_CHANNEL_ADDR: *mut u32 = 0xe0008840 as *mut u32;
  ...
  pub const RTIO_MONINJ_BASE: *mut u32 = 0xe0009000 as *mut u32;
  ...
  pub mod rtio_moninj {
    ...
    pub const MON_CHAN_SEL_ADDR: *mut u32 = 0xe0009000 as *mut u32;
    ...
    pub const MON_PROBE_SEL_ADDR: *mut u32 = 0xe0009008 as *mut u32;
    ...
    pub const MON_VALUE_UPDATE_ADDR: *mut u32 = 0xe0009010 as *mut u32;
    ...
    pub const MON_VALUE_ADDR: *mut u32 = 0xe0009018 as *mut u32;
    ...
    pub const INJ_CHAN_SEL_ADDR: *mut u32 = 0xe0009038 as *mut u32;
    ...
    pub const INJ_OVERRIDE_SEL_ADDR: *mut u32 = 0xe0009040 as *mut u32;
    ...
    pub const INJ_VALUE_ADDR: *mut u32 = 0xe0009048 as *mut u32;
  ...
  pub struct GrabberStruct {
    pub pll_reset_read: unsafe fn() -> u8,
    pub pll_reset_write: unsafe fn(u8),
    pub pll_locked_read: unsafe fn() -> u8,
    pub phase_shift_read: unsafe fn() -> u8,
    pub phase_shift_write: unsafe fn(u8),
    pub phase_shift_done_read: unsafe fn() -> u8,
    pub clk_sampled_read: unsafe fn() -> u8,
    pub freq_count_read: unsafe fn() -> u8,
    pub last_x_read: unsafe fn() -> u16,
    pub last_y_read: unsafe fn() -> u16,
  }

  pub const GRABBER: [GrabberStruct; 1] = [
    GrabberStruct {
      pll_reset_read: grabber0::pll_reset_read,
      pll_reset_write: grabber0::pll_reset_write,
      pll_locked_read: grabber0::pll_locked_read,
      phase_shift_read: grabber0::phase_shift_read,
      phase_shift_write: grabber0::phase_shift_write,
      phase_shift_done_read: grabber0::phase_shift_done_read,
      clk_sampled_read: grabber0::clk_sampled_read,
      freq_count_read: grabber0::freq_count_read,
      last_x_read: grabber0::last_x_read,
      last_y_read: grabber0::last_y_read,
    },
  ];

  pub const GRABBER_LEN: usize = 1;
  ...
  pub const CONFIG_HAS_GRABBER: u32 = 1;
  ...
  pub const CONFIG_IDENTIFIER_STR: &'static str = "9.0+unknown.beta;possible";
  pub const CONFIG_L2_SIZE: u32 = 131072;
  pub const CONFIG_RTIO_FREQUENCY: &'static str = "125.0";
  pub const CONFIG_RTIO_LOG_CHANNEL: u32 = 42;
