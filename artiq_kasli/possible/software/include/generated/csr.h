...
/* grabber0 */
#define CSR_GRABBER0_BASE 0xe0008000
#define CSR_GRABBER0_PLL_RESET_ADDR 0xe0008000
#define CSR_GRABBER0_PLL_RESET_SIZE 1
static inline unsigned char grabber0_pll_reset_read(void) {
	unsigned char r = MMPTR(0xe0008000);
	return r;
}
static inline void grabber0_pll_reset_write(unsigned char value) {
	MMPTR(0xe0008000) = value;
}
#define CSR_GRABBER0_PLL_LOCKED_ADDR 0xe0008008
#define CSR_GRABBER0_PLL_LOCKED_SIZE 1
static inline unsigned char grabber0_pll_locked_read(void) {
	unsigned char r = MMPTR(0xe0008008);
	return r;
}
#define CSR_GRABBER0_PHASE_SHIFT_ADDR 0xe0008010
#define CSR_GRABBER0_PHASE_SHIFT_SIZE 1
static inline unsigned char grabber0_phase_shift_read(void) {
	unsigned char r = MMPTR(0xe0008010);
	return r;
}
static inline void grabber0_phase_shift_write(unsigned char value) {
	MMPTR(0xe0008010) = value;
}
#define CSR_GRABBER0_PHASE_SHIFT_DONE_ADDR 0xe0008018
#define CSR_GRABBER0_PHASE_SHIFT_DONE_SIZE 1
static inline unsigned char grabber0_phase_shift_done_read(void) {
	unsigned char r = MMPTR(0xe0008018);
	return r;
}
#define CSR_GRABBER0_CLK_SAMPLED_ADDR 0xe0008020
#define CSR_GRABBER0_CLK_SAMPLED_SIZE 1
static inline unsigned char grabber0_clk_sampled_read(void) {
	unsigned char r = MMPTR(0xe0008020);
	return r;
}
#define CSR_GRABBER0_FREQ_COUNT_ADDR 0xe0008028
#define CSR_GRABBER0_FREQ_COUNT_SIZE 1
static inline unsigned char grabber0_freq_count_read(void) {
	unsigned char r = MMPTR(0xe0008028);
	return r;
}
#define CSR_GRABBER0_LAST_X_ADDR 0xe0008030
#define CSR_GRABBER0_LAST_X_SIZE 2
static inline unsigned short int grabber0_last_x_read(void) {
	unsigned short int r = MMPTR(0xe0008030);
	r <<= 8;
	r |= MMPTR(0xe0008038);
	return r;
}
#define CSR_GRABBER0_LAST_Y_ADDR 0xe0008040
#define CSR_GRABBER0_LAST_Y_SIZE 2
static inline unsigned short int grabber0_last_y_read(void) {
...
/* rtio_analyzer */
#define CSR_RTIO_ANALYZER_BASE 0xe0009800
#define CSR_RTIO_ANALYZER_ENABLE_ADDR 0xe0009800
...
static inline void rtio_analyzer_enable_write(unsigned char value) {
	MMPTR(0xe0009800) = value;
}
#define CSR_RTIO_ANALYZER_BUSY_ADDR 0xe0009808
...
#define CSR_RTIO_ANALYZER_MESSAGE_ENCODER_OVERFLOW_ADDR 0xe0009810
...
#define CSR_RTIO_ANALYZER_MESSAGE_ENCODER_OVERFLOW_RESET_ADDR 0xe0009818
...
#define CSR_RTIO_ANALYZER_DMA_RESET_ADDR 0xe0009820
...
#define CSR_RTIO_ANALYZER_DMA_BASE_ADDRESS_ADDR 0xe0009828
...
static inline unsigned long long int rtio_analyzer_dma_base_address_read(void) {
	unsigned long long int r = MMPTR(0xe0009828);
	r <<= 8;
	r |= MMPTR(0xe0009830);
	r <<= 8;
	r |= MMPTR(0xe0009838);
...
static inline void rtio_analyzer_dma_base_address_write(unsigned long long int value) {
	MMPTR(0xe0009828) = value >> 32;
	MMPTR(0xe0009830) = value >> 24;
	MMPTR(0xe0009838) = value >> 16;
	MMPTR(0xe0009840) = value >> 8;
	MMPTR(0xe0009848) = value;
}
#define CSR_RTIO_ANALYZER_DMA_LAST_ADDRESS_ADDR 0xe0009850
...
static inline unsigned long long int rtio_analyzer_dma_last_address_read(void) {
	unsigned long long int r = MMPTR(0xe0009850);
	r <<= 8;
	r |= MMPTR(0xe0009858);
	r <<= 8;
	r |= MMPTR(0xe0009860);
...
static inline void rtio_analyzer_dma_last_address_write(unsigned long long int value) {
	MMPTR(0xe0009850) = value >> 32;
	MMPTR(0xe0009858) = value >> 24;
	MMPTR(0xe0009860) = value >> 16;
	MMPTR(0xe0009868) = value >> 8;
	MMPTR(0xe0009870) = value;
}
#define CSR_RTIO_ANALYZER_DMA_BYTE_COUNT_ADDR 0xe0009878
...
static inline unsigned long long int rtio_analyzer_dma_byte_count_read(void) {
	unsigned long long int r = MMPTR(0xe0009878);
	r <<= 8;
	r |= MMPTR(0xe0009880);
	r <<= 8;
	r |= MMPTR(0xe0009888);
...
/* rtio_core */
#define CSR_RTIO_CORE_BASE 0xe0008800
#define CSR_RTIO_CORE_RESET_ADDR 0xe0008800
...
#define CSR_RTIO_CORE_RESET_PHY_ADDR 0xe0008808
...
#define CSR_RTIO_CORE_SED_SPREAD_ENABLE_ADDR 0xe0008810
...
#define CSR_RTIO_CORE_ASYNC_ERROR_ADDR 0xe0008818
...
#define CSR_RTIO_CORE_COLLISION_CHANNEL_ADDR 0xe0008820
...
#define CSR_RTIO_CORE_BUSY_CHANNEL_ADDR 0xe0008830
#define CSR_RTIO_CORE_BUSY_CHANNEL_SIZE 2
static inline unsigned short int rtio_core_busy_channel_read(void) {
	unsigned short int r = MMPTR(0xe0008830);
	r <<= 8;
	r |= MMPTR(0xe0008838);
	return r;
}
#define CSR_RTIO_CORE_SEQUENCE_ERROR_CHANNEL_ADDR 0xe0008840
...
static inline unsigned short int rtio_core_sequence_error_channel_read(void) {
	unsigned short int r = MMPTR(0xe0008840);
	r <<= 8;
	r |= MMPTR(0xe0008848);
	return r;
}
...
/* rtio_moninj */
#define CSR_RTIO_MONINJ_BASE 0xe0009000
#define CSR_RTIO_MONINJ_MON_CHAN_SEL_ADDR 0xe0009000
...
#define CSR_RTIO_MONINJ_MON_PROBE_SEL_ADDR 0xe0009008
...
static inline void rtio_moninj_mon_probe_sel_write(unsigned char value) {
	MMPTR(0xe0009008) = value;
}
#define CSR_RTIO_MONINJ_MON_VALUE_UPDATE_ADDR 0xe0009010
...
#define CONFIG_IDENTIFIER_STR "9.0+unknown.beta;possible"
static inline const char * config_identifier_str_read(void) {
	return "9.0+unknown.beta;possible";
}
...
#define CONFIG_RTIO_LOG_CHANNEL 42
